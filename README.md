...
- NOTE: I'm using SQLAlchemy for my database and the code & schemas is currently defined in data_collector.py (in the StreamingSearch & IndividualResults classes). These will be moved into their own classes at a later date.